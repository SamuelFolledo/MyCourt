...
//to fix...
                ...
                user.userUid = snapshot.key //ep.9 added so we know who we are sending to
...
//cellForRowAt
    ...
    var messagesController: MessagesController? //ep.9 assign messagesController.messagesController = self in MessagesController
    
//didSelectRowAtIndexPath //in here we will want to dismiss this vc then send the user we selected to the ChatLog
