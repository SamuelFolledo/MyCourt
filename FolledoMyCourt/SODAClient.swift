...
//  FolledoMyCourt
//
//  Created by Samuel Folledo on 6/16/19.
...
public class SODAClient {
    ...
    public func get(dataset: String, withFilters: [String: String], limit: Int = 1000, offset: Int = 0, _ completionHandler: @escaping SODADatasetCompletionHandler) {
        var ps = withFilters
        ps["$limit"] = "\(limit)"
        ps["$offset"] = "\(offset)"
